        ...
        <div class="flex flex-1 items-center justify-center">
            <div class="rounded-lg sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
                ...
                <form @submit.prevent="register" class="text-center">
                    ...
                    <div class="py-2 text-left">
                        <input v-model="state.password_confirmation" type="password" class="bg-gray-200 border-2 border-gray-100 focus:outline-none bg-gray-100 block w-full py-2 px-4 rounded-lg focus:border-gray-700 " placeholder="Confirm Password" />
                    </div>
                    <div class="py-2">
                ...
                <div class="text-center mt-12">
                    ...
                    <a href="/login" class="font-light text-md text-indigo-600 underline font-semibold hover:text-indigo-800">
                        Login
                    </a>
                </div>
            </div>
